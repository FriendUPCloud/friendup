...
if( !class_exists( 'DoorArena' ) )
{
	class DoorArena extends Door
	{	
...
// Create a door...
$door = new DoorArena( isset( $path ) ? $path : ( ( isset( $args ) && isset( $args->args ) && $args->args->path ) ? $args->args->path : false ) );
