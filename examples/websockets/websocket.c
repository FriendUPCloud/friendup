...
static int callback_http(struct libwebsocket_context * this, struct libwebsocket *wsi, enum libwebsocket_callback_reasons reason, void *user,
							   void *in, size_t len)
{
	int n;
...
{
	int n = 0;
	const char *cert_path ="/home/stefkos/development/FriendUp/friendup/docs/examples/crt/key.pem";//LOCAL_RESOURCE_PATH"/libwebsockets-test-server.pem";
	const char *key_path ="/home/stefkos/development/FriendUp/friendup/docs/examples/crt/key.pem";//LOCAL_RESOURCE_PATH"/libwebsockets-test-server.key.pem";
