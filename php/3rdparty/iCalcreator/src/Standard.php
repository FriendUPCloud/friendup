...
/**
 * iCalcreator (Vtimezone) Standard component class
 *
 * @author Kjell-Inge Gustafsson, kigkonsult <ical@kigkonsult.se>
 * @since  2.27.6 - 2018-12-28
 */
final class Standard extends CalendarComponent
{
    ...
    /**
     * Return formatted output for calendar component VTIMEZONE Standard object instance
     *
     * @return string
