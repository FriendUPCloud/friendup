...
echo
echo "Warning! If you have defined TLS keys, FriendCore will run in TLS mode,"
echo "you will have to connect to your Friend machine with the following URL:"
echo "https://$friendCoreDomain:6502" and no longer 'http://'...
echo
exit 0
