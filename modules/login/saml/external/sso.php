<?php
	...
	/*
		This file is supposed to be placed in the www directory of your SimpleSAMLPHP installation
		
		it interfaces with SimpleSAMLPHP which needs an established trust relation with the identification provider
		
		The userattribute transfer in lines 61ff will probably have to be adapted from customer to customer
		
		The other main adaptoins to be dine in this file are lines 21 and 34 - the HTTP end point for this file and line 61 the auth file in the saml module in friend on the machine.
	*/
