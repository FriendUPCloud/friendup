		...
		case 'sendinvite':
			...
			if( $usr->Load() )
			{
				...
				if( $online )
				{
					...
					$n->ActionAccepted = '{"module":"module.php","command":"verifyinvite","args":{"hash":"'.$hash.'"},"skip":"true"}';
					$n->ActionRejected = '{"module":"module.php","command":"removeinvite","args":{"hash":"'.$hash.'"},"skip":"true"}';
					if( $n->Load() )
					{
