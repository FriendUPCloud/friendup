...
Friend.Workspace.Folder = function( tree, name, flags )
{
 	Friend.Tree.Items.init( this, tree, name, 'Friend.Tree.Game.Sprite', flags );
};
Friend.Workspace.Folder.render = function( flags )
{
	return flags;
};
Friend.Workspace.Folder.messageUp = function( message )
{
 	return this.startProcess( message, [] );
};
Friend.Workspace.Folder.messageDown = function( message )
{
