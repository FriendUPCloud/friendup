...
class View
{
	...
	setContentIframed( content, domain, packet, callback )
	{
		let self = this;
		if( !domain )
		{
	...
	setContentById( content, packet, callback )
	{
		let self = this;
		if( this.iframe )
		{
	...
	focusOnElement( identifier, flag )
	{
		let self = this;
	...
	getContentById( identifier, flag )
	{
		let self = this;
	...
	setSubContent( identifier, flag, content )
	{
		let self = this;
	...
	createContentEventFuncs = function( cont )
	{
	...
	// Parse view window flags
	parseFlags( flags, filter )
	{
	...
	addEventByClass( className, event, func )
	{
	...
	// Set another window as foremost, blocking this one
	setBlocker( blockwin )
	{
		this._window.blocker = blockwin;
	}
	// Remove the blocking window
	removeBlocker()
	{
	...
	handleKeys = function( k, event )
	{
	}
	// This window is sticky
	setSticky = function()
	{
	...
	createDomElements( div, titleStr, width, height, id, flags, applicationId, parentOverride = false )
	{
		let self = this;
